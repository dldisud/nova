...
values
  ...
  ('fantasy', '판타지', 'genre'),
  ('romance-fantasy', '로맨스 판타지', 'genre'),
  ('academy', '아카데미', 'genre'),
  ('modern-fantasy', '현대 판타지', 'genre'),
  ('mystery', '미스터리', 'genre'),
  ('sf', 'SF', 'genre'),
  ('martial-arts', '무협', 'genre'),
  ('regression', '회귀', 'theme'),
  ('possession', '빙의', 'theme'),
  ('reincarnation', '환생', 'theme'),
  ('growth', '성장', 'theme'),
  ('revenge', '복수', 'theme'),
  ...
  ('power-fantasy', '먼치킨', 'tone'),
  ('dark-tone', '피폐', 'tone'),
  ('hardboiled', '하드보일드', 'tone'),
  ('ensemble-cast', '군상극', 'tone'),
  ('long-run', '장기 연재', 'format'),
  ('bundle-sale', '완결 번들', 'event'),
  ('female-audience', '여성향', 'audience'),
  ('male-audience', '남성향', 'audience')
